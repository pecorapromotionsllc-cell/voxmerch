...
**Confirmed by Mary Anne 2026-08-01: the published price is what the partner resells at. Partner cost
is 40% below that, and partner cost is what VoxMerch collects.**

| Tier | Client pays the partner | Partner pays VoxMerch | Partner margin | Activations | Extra activations | Includes |
|---|---|---|---|---|---|---|
| Essential | $3,500 | **$2,100** | $1,400 | up to 150 | $18 each | Platform + live artwork display |
| Plus | $7,000 | **$4,200** | $2,800 | up to 300 | $16 each | + SMS artwork delivery |
| Advanced | $11,700 | **$7,020** | $4,680 | up to 500 | $14 each | + Data Insights report |
| Enterprise | $17,500 | **$10,500** | $7,000 | up to 750 | $12 each | + full White Label |

The bolded column is VoxMerch revenue. Use it for every forecast. The plan's revenue table already
reflects this and needs no change.
...
## The intelligence asset: available at every tier

**"Data Insights" and "the intelligence asset" are the same product.** Use the customer-facing name,
the intelligence asset, in outbound and on calls. Data Insights is the internal and portal label.

**It can be added to any tier.** Baked into Advanced and Enterprise at no extra cost, and available
a la carte at Essential and Plus for $2,500. So leading email 1 with the intelligence asset is sound:
nobody has to buy up a tier to get it.

The only thing to be explicit about on a call is that at Essential or Plus it is an add-on rather
than automatic. Never let a client assume the base package includes it, and never imply they need
Advanced to get it. Both would be wrong.
...
## RESOLVED, and it means the FAQ has an error in it

Mary Anne confirmed on 2026-08-01: **published price is partner resale, partner cost is 40% below,
VoxMerch collects the partner cost.** The plan was right. Its revenue table stands and the October
$15K to $45K target is unaffected.

**`VoxMerch_FAQs.txt` states the opposite and should be corrected.** Its opening line reads:

> "All prices shown are client prices (the price the channel partner pays VoxMerch)."

Under the confirmed model, $3,500 is not what the partner pays VoxMerch. It is what the partner
charges their client. The partner pays $2,100.

This matters more than a stray line in an internal file. That FAQ is described in its own header as
the reference for "1:1 sales conversations, follow-up emails, and proposals." Anyone selling from it,
Debra included, would quote partner economics that are 67% too high and could commit to margin that
does not exist. Worth fixing at the source.
...
| Tier prices treated as partner cost, per the FAQ | Confirmed 2026-08-01: published price is partner **resale**; partner cost is 40% below; VoxMerch collects the partner cost. The FAQ is wrong on this and needs correcting at source. |
| "Data Insights is not included at Essential or Plus", framed as a gap | It can be added to **any** tier: free at Advanced and Enterprise, $2,500 a la carte at Essential and Plus. Customer-facing name is **the intelligence asset**. |
